...
<body>
    ...
    ?>
    <section class="state state-wait center-align valign-wrapper">
        <div class="container">
            <i class="fa-solid fa-hand"></i>
            <h1>Compra en espera</h1>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus fringilla nulla nec leo luctus, vel sagittis nibh porta.</p>
            <br>
